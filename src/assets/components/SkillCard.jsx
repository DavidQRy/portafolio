...
const SkillCard = ({icon, skillName, description,progress}) => {
  return (
    <div className='bg-white rounded-2xl border boder boder-[#10B981] p-4'>
        <div className="flex gap-3">
            <div className="w-10 h-10 flex items-center justify-center bg-gradient-to-b from-[#D1FAE5] to-[#ffffff] rounded-[7px]">
                {icon}
            </div>
        ...
        <p className="text-xs text-gray-600 text-justify leadding-5 mt-2">
            {description}
        </p>
    </div>
  )
